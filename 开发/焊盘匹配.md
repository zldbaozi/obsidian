...
QList<QGraphicsItem*> ImageView::GetSelectedItems()
{
    ...
    // 获取图层列表 (逻辑与 delete 一样)
    QMap<QString, QGraphicsItemGroup *> groups = GetImageLayers();
    ...
    for (auto it = groups.begin(); it != groups.end(); ++it)
    {
        ...
        LayerType type = group->data(Qt::UserRole + 1).value<LayerType>();
        ...
        for (QGraphicsItem* item : group->childItems())
        {
            ...
            {
                CrossItem* crossItem = dynamic_cast<CrossItem*>(item);
